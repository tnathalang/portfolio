            ...
            <div href="#about">
                <div className="AboutMe">
                    <div className="profile">
                        <img src={profile} className="w3-round w3-image" alt="Photo of Me" />
                    </div>
                    <div className="AboutMe-text">
                        ...
                        <p>
                            ...
                            At first, as a kid, I wanted to become an architect or even a video-games developer, since I love playing it so much. However,
                        as I get older, and trying out many different job fields, I realize that <b>nothing sparks me joy as much as programming.</b>,
                                ...
                                it honestly feels very fufilling. My go to cuisine is Japanese cuisine, but I also love Thai food, the spicier the better,
                        I love Jazz, RnB and Hip-Hop. <b>One of my dreams would be to work in Japan as a developer one day.</b>
                        </p>
                        <h3 className="proverb">
                            <h3 className="quote"><b>I live by</b> </h3>
                            虎穴に入らずんば虎子を得ず.
