        ...
        <div className="AboutMe">
          ...
          <div className="AboutMe-text">
            ...
            <p>
              ...
              architect or even a video-games developer, since I love playing it
              so much. However, as I get older, and trying out many different
              job fields, I realize that{" "}
              <b>nothing sparks me joy as much as programming.</b>, With the
              technology world evolving extremely fast, to be able to learn
              something and create something at the same time, it honestly feels
              very fufilling. My go to cuisine is Japanese cuisine, but I also
              love Thai food, the spicier the better, I love Jazz, RnB and
              Hip-Hop.{" "}
              <b>
                One of my dreams would be to work in Japan as a developer one
                day.
              </b>
              <b>
